...
SPIPollReadFifo_1:
       ...
       and.b     #1,D0
       cmp.b     #1,D0
       bne.s     SPIPollReadFifo_3
       bra       SPIPollReadFifo_1
SPIPollReadFifo_3:
       rts
; }
...
SPIFlashPollStatusWLE_1:
       ...
       lsr.b     #1,D0
       and.b     #1,D0
       bne.s     SPIFlashPollStatusWLE_3
       bra       SPIFlashPollStatusWLE_1
SPIFlashPollStatusWLE_3:
; SPI_CS = 0xFF;
       move.b    #255,4227112
       rts
; }
...
; if ((((SPI_Data) & 0x1) == 1)) {
       ...
       and.b     #1,D0
       cmp.b     #1,D0
       bne.s     SPIFlashPollStatusBusy_1
; printf("\r\n SPI_DATA REG: %08x  \n", SPI_Data);
       move.b    4227108,D1
       and.l     #255,D1
       move.l    D1,-(A7)
       ...
       jsr       _printf
       addq.w    #8,A7
       bra.s     SPIFlashPollStatusBusy_2
...
; void SPIWriteSendAddress(int c) {
       xdef      _SPIWriteSendAddress
_SPIWriteSendAddress:
       link      A6,#0
       movem.l   D2/A2,-(A7)
       move.l    8(A6),D2
...
@m68kde~1_22:
       dc.b      13,10,32,83,80,73,95,68,65,84,65,32,82,69,71
       dc.b      58,32,37,48,56,120,32,32,10,0
@m68kde~1_23:
       dc.b      83,117,99,99,101,115,102,117,108,108,10,0
@m68kde~1_24:
