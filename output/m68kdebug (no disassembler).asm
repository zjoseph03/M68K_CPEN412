...
; wait5ms();
       jsr       _wait5ms
       bra.s     EEPROMFlashPageWrite_12
EEPROMFlashPageWrite_9:
; } else if (currentAddress == endAddress - 1) {
       move.l    A4,D0
       subq.l    #1,D0
       cmp.l     D0,D3
       bne.s     EEPROMFlashPageWrite_11
; pageFlag = 0;
       clr.l     D4
; IIC_CRSR = STOP | WRITE | IACK;
       move.b    #81,4227080
...
EEPROMReadBlock0_7:
       ...
       moveq     #1,D0
       bra.s     EEPROMReadBlock0_11
EEPROMReadBlock0_10:
       clr.l     D0
EEPROMReadBlock0_11:
       and.b     #1,D0
       beq.s     EEPROMReadBlock0_9
...
@m68kde~1_28:
       dc.b      10,0
@m68kde~1_29:
       dc.b      83,116,97,114,116,32,65,100,100,114,58,32,37
       dc.b      100,10,32,67,117,114,114,32,65,100,100,114,58
       dc.b      32,37,100,44,32,82,101,97,100,32,76,101,110
       dc.b      58,32,37,100,10,0
@m68kde~1_30:
       dc.b      13,10,32,66,108,111,99,107,32,48,32,65,100,100
       dc.b      114,101,115,115,58,32,37,100,58,32,37,100,10
       dc.b      0
@m68kde~1_31:
